...
Z([3,'__e'])
Z([3,'example-box'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'navato']],[[4],[[5],[[7],[3,'index']]]]]]]]]]]])
Z([3,'__l'])
Z(z[4])
Z([[4],[[5],[[4],[[5],[[5],[1,'^click']],[[4],[[5],[[4],[[5],[[5],[1,'navato']],[[4],[[5],[[7],[3,'index']]]]]]]]]]]])
Z([1,true])
Z([[2,'+'],[[2,'+'],[[7],[3,'index']],[1,1]],[1,'测站']])
Z([[2,'+'],[1,'1-'],[[7],[3,'index']]])
Z([[4],[[5],[1,'default']]])
...
var x=['./components/uni-card/uni-card.wxml','./pages/index/index.wxml','./pages/level/level.wxml','./pages/record/record.wxml'];d_[x[0]]={}
...
var oX=_mz(z,'view',['bindtap',4,'class',1,'data-event-opts',2],[],hU,cT,gg)
var lY=_mz(z,'uni-card',['bind:__l',7,'bind:click',1,'data-event-opts',2,'isShadow',3,'title',4,'vueId',5,'vueSlots',6],[],hU,cT,gg)
_(oX,lY)
_(oV,oX)
return oV
}
...
__wxAppCode__['app.json']={"pages":["pages/index/index","pages/level/level","pages/record/record"],"window":{"navigationBarTextStyle":"black","navigationBarTitleText":"uni-app","navigationBarBackgroundColor":"#F8F8F8","backgroundColor":"#F8F8F8"},"nvueCompiler":"weex","renderer":"auto","splashscreen":{"alwaysShowBeforeRender":true,"autoclose":false},"appname":"测量小程序","compilerVersion":"2.2.2","usingComponents":{"level":"/pages/level/level","uni-card":"/components/uni-card/uni-card"}};
__wxAppCode__['app.wxml']=$gwx('./app.wxml');

__wxAppCode__['components/uni-card/uni-card.json']={"usingComponents":{},"component":true};
__wxAppCode__['components/uni-card/uni-card.wxml']=$gwx('./components/uni-card/uni-card.wxml');

__wxAppCode__['pages/index/index.json']={"navigationBarTitleText":"uni-app","usingComponents":{"uni-card":"/components/uni-card/uni-card"}};
__wxAppCode__['pages/index/index.wxml']=$gwx('./pages/index/index.wxml');

__wxAppCode__['pages/level/level.json']={"usingComponents":{}};
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["common/main","pages/level/level"],{"0b6a":function(t,e,i){"use strict";i.r(e);var s=i("d64d"),l=i.n(s);for(var n in s)"default"!==n&&function(t){i.d(e,t,function(){return s[t]})}(n);e["default"]=l.a},"20a2":function(t,e,i){"use strict";i.r(e);var s=i("215c"),l=i("0b6a");for(var n in l)"default"!==n&&function(t){i.d(e,t,function(){return l[t]})}(n);i("2820");var a=i("2877"),r=Object(a["a"])(l["default"],s["a"],s["b"],!1,null,null,null);e["default"]=r.exports},"215c":function(t,e,i){"use strict";var s=function(){var t=this,e=t.$createElement;t._self._c},l=[];i.d(e,"a",function(){return s}),i.d(e,"b",function(){return l})},2820:function(t,e,i){"use strict";var s=i("539c"),l=i.n(s);l.a},"539c":function(t,e,i){},"7cda":function(t,e,i){"use strict";var s=i("fd8e"),l=i.n(s);l.a},c043:function(t,e,i){"use strict";(function(t,i){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var s={onLaunch:function(){var e,s;console.log(t("App Launch"," at App.vue:14")),i.getStorage({key:"rlist",success:function(i){console.log(t("resdata",i.data," at App.vue:18")),null!=i.data&&void 0!=i.data&&""!=i.data&&(e=i.data)}}),null!=e&&void 0!=e&&""!=e&&(this.GV.rlist=e),i.getStorage({key:"vrlist",success:function(e){console.log(t("resdata",e.data," at App.vue:28")),null!=e.data&&void 0!=e.data&&""!=e.data&&(s=e.data)}}),null!=s&&void 0!=s&&""!=s&&(this.GV.vrlist=s),console.log(t("gh",this.GV.vrlist," at App.vue:35"))},onShow:function(){console.log(t("App Show"," at App.vue:38"))},onHide:function(){console.log(t("App Hide"," at App.vue:42"))},methods:{}};e.default=s}).call(this,i("0de9")["default"],i("6e42")["default"])},d64d:function(t,e,i){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var i={name:"level",data:function(){return{id:0,title:"Hello",ldr1:new this.angle,ldr2:new this.angle,ldr3:new this.angle,vv1:new this.angle,vv2:new this.angle,vv3:new this.angle,vv4:new this.angle,vv5:new this.angle,vv6:new this.angle,vv7:new this.angle,vv8:new this.angle}},onUnload:function(){},onLoad:function(e){this.id=e.id,console.log(t("thisid:"+this.id," at pages\\level\\level.vue:179"))},methods:{ldrreset:function(t){this.GV.rlist[this.id].reset(),t<2?this.ldr1=this.GV.rlist[this.id].ldr[4]:t>1&&t<4&&(this.ldr2=this.GV.rlist[this.id].ldr[5]),this.ldr3=this.GV.rlist[this.id].ldr[6]},inputdegree:function(e){this.GV.rlist[this.id].ldr[e.target.dataset.cur].setdegree(Number(e.target.value)),console.log(t(this.GV.rlist[this.id]," at pages\\level\\level.vue:195")),this.ldrreset(e.target.dataset.cur)},inputminute:function(e){this.GV.rlist[this.id].ldr[e.target.dataset.cur].setminute(Number(e.target.value)),console.log(t(this.GV.rlist[this.id]," at pages\\level\\level.vue:200")),this.ldrreset(e.target.dataset.cur)},inputsecond:function(e){this.GV.rlist[this.id].ldr[e.target.dataset.cur].setsecond(Number(e.target.value)),console.log(t(this.GV.rlist[this.id]," at pages\\level\\level.vue:205")),this.ldrreset(e.target.dataset.cur),console.log(t(this.GV.rlist[this.id].ldr[4].degree," at pages\\level\\level.vue:207"))},vvreset:function(t){this.GV.vrlist[this.id].reset(),t<2?this.vv1=this.GV.vrlist[this.id].vv[4]:t>1&&t<4&&(this.vv2=this.GV.vrlist[this.id].vv[5]),this.vv3=this.GV.vrlist[this.id].vv[6],this.vv4=this.GV.vrlist[this.id].vv[7],this.vv5=this.GV.vrlist[this.id].vv[8],this.vv6=this.GV.vrlist[this.id].vv[9],this.vv7=this.GV.vrlist[this.id].vv[10],this.vv8=this.GV.vrlist[this.id].vv[11]},inputvvdegree:function(e){this.GV.vrlist[this.id].vv[e.target.dataset.cur].setdegree(Number(e.target.value)),console.log(t(this.GV.rlist[this.id]," at pages\\level\\level.vue:228")),this.vvreset(e.target.dataset.cur)},inputvvminute:function(e){this.GV.vrlist[this.id].vv[e.target.dataset.cur].setminute(Number(e.target.value)),console.log(t(this.GV.vrlist[this.id]," at pages\\level\\level.vue:233")),this.vvreset(e.target.dataset.cur)},inputvvsecond:function(e){this.GV.vrlist[this.id].vv[e.target.dataset.cur].setsecond(Number(e.target.value)),console.log(t(this.GV.vrlist[this.id]," at pages\\level\\level.vue:238")),this.vvreset(e.target.dataset.cur),console.log(t(this.GV.vrlist[this.id].vv[4].degree," at pages\\level\\level.vue:240"))}}};e.default=i}).call(this,i("0de9")["default"])},e9c4:function(t,e,i){"use strict";i.r(e);var s=i("ebd0");for(var l in s)"default"!==l&&function(t){i.d(e,t,function(){return s[t]})}(l);i("7cda");var n,a,r=i("2877"),v=Object(r["a"])(s["default"],n,a,!1,null,null,null);e["default"]=v.exports},ebd0:function(t,e,i){"use strict";i.r(e);var s=i("c043"),l=i.n(s);for(var n in s)"default"!==n&&function(t){i.d(e,t,function(){return s[t]})}(n);e["default"]=l.a},fd8e:function(t,e,i){}},[["44e6","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"] = global["webpackJsonp"] || []).push([["components/uni-card/uni-card"], {
  ...
  "5b10": function b10(t, e, n) {},
  "64e9": function e9(t, e, n) {
    "use strict";
...
(global["webpackJsonp"] = global["webpackJsonp"] || []).push(['components/uni-card/uni-card-create-component', {
  'components/uni-card/uni-card-create-component': function componentsUniCardUniCardCreateComponent(module, exports, __webpack_require__) {
    __webpack_require__('6e42')['createComponent'](__webpack_require__("e38f"));
  }
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/level/level"],{"0b6a":function(t,e,i){"use strict";i.r(e);var s=i("d64d"),l=i.n(s);for(var v in s)"default"!==v&&function(t){i.d(e,t,function(){return s[t]})}(v);e["default"]=l.a},"20a2":function(t,e,i){"use strict";i.r(e);var s=i("215c"),l=i("0b6a");for(var v in l)"default"!==v&&function(t){i.d(e,t,function(){return l[t]})}(v);i("2820");var r=i("2877"),n=Object(r["a"])(l["default"],s["a"],s["b"],!1,null,null,null);e["default"]=n.exports},"215c":function(t,e,i){"use strict";var s=function(){var t=this,e=t.$createElement;t._self._c},l=[];i.d(e,"a",function(){return s}),i.d(e,"b",function(){return l})},2820:function(t,e,i){"use strict";var s=i("539c"),l=i.n(s);l.a},"539c":function(t,e,i){},d64d:function(t,e,i){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var i={name:"level",data:function(){return{id:0,title:"Hello",ldr1:new this.angle,ldr2:new this.angle,ldr3:new this.angle,vv1:new this.angle,vv2:new this.angle,vv3:new this.angle,vv4:new this.angle,vv5:new this.angle,vv6:new this.angle,vv7:new this.angle,vv8:new this.angle}},onUnload:function(){},onLoad:function(e){this.id=e.id,console.log(t("thisid:"+this.id," at pages\\level\\level.vue:179"))},methods:{ldrreset:function(t){this.GV.rlist[this.id].reset(),t<2?this.ldr1=this.GV.rlist[this.id].ldr[4]:t>1&&t<4&&(this.ldr2=this.GV.rlist[this.id].ldr[5]),this.ldr3=this.GV.rlist[this.id].ldr[6]},inputdegree:function(e){this.GV.rlist[this.id].ldr[e.target.dataset.cur].setdegree(Number(e.target.value)),console.log(t(this.GV.rlist[this.id]," at pages\\level\\level.vue:195")),this.ldrreset(e.target.dataset.cur)},inputminute:function(e){this.GV.rlist[this.id].ldr[e.target.dataset.cur].setminute(Number(e.target.value)),console.log(t(this.GV.rlist[this.id]," at pages\\level\\level.vue:200")),this.ldrreset(e.target.dataset.cur)},inputsecond:function(e){this.GV.rlist[this.id].ldr[e.target.dataset.cur].setsecond(Number(e.target.value)),console.log(t(this.GV.rlist[this.id]," at pages\\level\\level.vue:205")),this.ldrreset(e.target.dataset.cur),console.log(t(this.GV.rlist[this.id].ldr[4].degree," at pages\\level\\level.vue:207"))},vvreset:function(t){this.GV.vrlist[this.id].reset(),t<2?this.vv1=this.GV.vrlist[this.id].vv[4]:t>1&&t<4&&(this.vv2=this.GV.vrlist[this.id].vv[5]),this.vv3=this.GV.vrlist[this.id].vv[6],this.vv4=this.GV.vrlist[this.id].vv[7],this.vv5=this.GV.vrlist[this.id].vv[8],this.vv6=this.GV.vrlist[this.id].vv[9],this.vv7=this.GV.vrlist[this.id].vv[10],this.vv8=this.GV.vrlist[this.id].vv[11]},inputvvdegree:function(e){this.GV.vrlist[this.id].vv[e.target.dataset.cur].setdegree(Number(e.target.value)),console.log(t(this.GV.rlist[this.id]," at pages\\level\\level.vue:228")),this.vvreset(e.target.dataset.cur)},inputvvminute:function(e){this.GV.vrlist[this.id].vv[e.target.dataset.cur].setminute(Number(e.target.value)),console.log(t(this.GV.vrlist[this.id]," at pages\\level\\level.vue:233")),this.vvreset(e.target.dataset.cur)},inputvvsecond:function(e){this.GV.vrlist[this.id].vv[e.target.dataset.cur].setsecond(Number(e.target.value)),console.log(t(this.GV.vrlist[this.id]," at pages\\level\\level.vue:238")),this.vvreset(e.target.dataset.cur),console.log(t(this.GV.vrlist[this.id].vv[4].degree," at pages\\level\\level.vue:240"))}}};e.default=i}).call(this,i("0de9")["default"])}},[["5d40","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/record/record"],{"1ea9":function(t,i,r){},"1ece":function(t,i,r){"use strict";r.r(i);var e=r("b939"),n=r.n(e);for(var l in e)"default"!==l&&function(t){r.d(i,t,function(){return e[t]})}(l);i["default"]=n.a},"51ee":function(t,i,r){"use strict";r.r(i);var e=r("a2ca"),n=r("1ece");for(var l in n)"default"!==l&&function(t){r.d(i,t,function(){return n[t]})}(l);r("8e5c");var s=r("2877"),d=Object(s["a"])(n["default"],e["a"],e["b"],!1,null,null,null);i["default"]=d.exports},"8e5c":function(t,i,r){"use strict";var e=r("1ea9"),n=r.n(e);n.a},a2ca:function(t,i,r){"use strict";var e=function(){var t=this,i=t.$createElement;t._self._c},n=[];r.d(i,"a",function(){return e}),r.d(i,"b",function(){return n})},b939:function(t,i,r){"use strict";(function(t){Object.defineProperty(i,"__esModule",{value:!0}),i.default=void 0;var r={data:function(){return{id:0,title:"Hello",ldr:new Array,vv:new Array}},onLoad:function(t){this.id=t.id,this.ldr[0]=this.GV.rlist[this.id].ldr[0],this.ldr[1]=this.GV.rlist[this.id].ldr[1],this.ldr[2]=this.GV.rlist[this.id].ldr[2],this.ldr[3]=this.GV.rlist[this.id].ldr[3],this.ldr[4]=this.GV.rlist[this.id].ldr[4],this.ldr[5]=this.GV.rlist[this.id].ldr[5],this.ldr[6]=this.GV.rlist[this.id].ldr[6],this.vv=this.GV.vrlist[this.id].vv},methods:{navato_mod:function(){var i=Number(this.id);t.navigateTo({url:"../level/level?id="+i})}}};i.default=r}).call(this,r("6e42")["default"])}},[["1345","common/runtime","common/vendor"]]]);
});
